 ...
 * implementations of this interface. The most simple implementation would be a battery that
 * outputs a constant voltage, while more a sophisticated implementation
 */
public interface BatterySim {
  /**
   * Sets the current draw generated by all running mechanisms. Call
   * {@link #update(double) update()} and then {@link #getVoltage()} to determine the output voltage
   * of the battery after setting the current draw.
   */
